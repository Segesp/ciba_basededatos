...
Se agregó un worker experimental en `workers/faceswap_worker_wan22.py` para probar **yetter-ai/Wan2.2-TI2V-5B-Turbo-Diffusers** (más liviano para este entorno).
